var createFFmpegCore = (function () {
  ...
  return (
    function (createFFmpegCore) {
      ...
      var oa, y, v, Qa, Ra, E, F, G, Sa, Ta = f.INITIAL_MEMORY || 1073741824;
      ...
      f.dynCall_jii = function () {
        return (f.dynCall_jii = f.asm.Je).apply(null, arguments)
      };
      var Ie = f.dynCall_iij = function () {
        return (Ie = f.dynCall_iij = f.asm.Ke).apply(null, arguments)
      };
      f.dynCall_jiiii = function () {
        return (f.dynCall_jiiii = f.asm.Le).apply(null, arguments)
      };
      ...
      f._ff_h264_cabac_tables = 2040838;
      var xb = f._main_thread_futex = 16782872;
